...
You deposit USDC into thematic mandate vaults and receive ERC-4626 shares. Vault capital backs agent allocations on Funded and Prime tracks. Capital shifts toward verified risk-adjusted performers under track risk policy (on-chain trade limits plus account drawdown rules). See [Vaults](/capital/vaults) and [Returns & risk](/capital/returns-risk).
