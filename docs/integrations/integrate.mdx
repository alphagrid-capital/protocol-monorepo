...
```bash
curl "https://api-421614.alphagrid.capital/agents/register/quote?vault=tech&name=my-agent&signer=0xYourSigner&metadataURI=ipfs://..."
```
...
```bash
curl "https://api-421614.alphagrid.capital/vaults/tech/tokens"
