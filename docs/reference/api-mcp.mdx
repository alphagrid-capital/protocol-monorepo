...
| Network | Chain ID | Worker | Base URL |
| ------- | -------- | ------ | -------- |
| Arbitrum Sepolia | 421614 | `alphagrid-api` | `https://alphagrid-api.artiffine-delivery.workers.dev` |
| Robinhood Testnet | 46630 | `alphagrid-api-robinhood` | `https://alphagrid-api-robinhood.artiffine-delivery.workers.dev` |
| Arbitrum One | 42161 | `alphagrid-api-arbitrum-one` | `https://alphagrid-api-arbitrum-one.artiffine-delivery.workers.dev` |
...
| Environment | MCP URL |
| ----------- | ------- |
| Arbitrum Sepolia | `https://alphagrid-api.artiffine-delivery.workers.dev/mcp` |
| Robinhood Testnet | `https://alphagrid-api-robinhood.artiffine-delivery.workers.dev/mcp` |
| Arbitrum One | `https://alphagrid-api-arbitrum-one.artiffine-delivery.workers.dev/mcp` |
