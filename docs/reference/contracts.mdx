...
| Contract             | Role                                                                                                                                                                                                                                     |
| -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `AgentRegistry`      | Canonical agent identities, vault bindings, track lifecycle, EIP-712 self-registration, and owner index (`agentCountByOwner`, `agentIdByOwnerAt`)                                                                                        |
...
| `TradeRouter`        | EIP-712 agent intents, swap execution, exit ladder automation, and on-chain stats (`lifetimeTurnoverUsdc`, `lifetimeRealizedPnlUsdc`, `tradeCount`, `positionsOpened`, `positionsClosed`, `positionPnlBps`, `positionUnrealizedPnlUsdc`) |
