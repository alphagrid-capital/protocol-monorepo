...
Always fetch `GET /agents/register/quote?signer=0x...` first. Use the returned `eip712.verifyingContract`, `eip712.selfRegisterTypehash`, and `signerNonce` (do not hardcode addresses from this page).
